#ifndef HALIDE__even_static_h
#define HALIDE__even_static_h
#include <stdint.h>
...
int even(struct halide_buffer_t *_even_buffer);

HALIDE_FUNCTION_ATTRS
int even_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *even_metadata();
