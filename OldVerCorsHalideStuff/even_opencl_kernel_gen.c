...
/*@
 requires _even != NULL;
 requires _in != NULL;
 //requires _in_in_even__0_0 != NULL;
 context_everywhere get_local_size(0) == 33;
 context_everywhere  get_num_groups(0) == 4;
 requires shared_mem_size_1 == 33;

 requires \ltid<32&&  ((get_group_id(0)*32) + get_local_id(0)) <= 127 ==> Perm(_in[(get_group_id(0)*32) + get_local_id(0)], read);
 requires \ltid==32&& ((get_group_id(0)*32) + get_local_id(0)) <= 127 ==> Perm(_in[(get_group_id(0)*32) + get_local_id(0)], read);
 requires ((get_group_id(0)*32) + get_local_id(0)) <= 127 ==> Perm(_in_in_even__0_0[get_local_id(0)], write);
 context \ltid<32&& ((get_group_id(0)*32) + get_local_id(0)) <= 126 ==> Perm(_even[(get_group_id(0)*32) + get_local_id(0)], 1\1);

 requires \ltid<32&&  ((get_group_id(0)*32) + get_local_id(0)) <= 127 ==> _in[(get_group_id(0)*32) + get_local_id(0)] % 2 == 0;
 requires \ltid==32&& ((get_group_id(0)*32) + get_local_id(0)) <= 127 ==> _in[(get_group_id(0)*32) + get_local_id(0)] % 2 == 0;

 //requires ((get_group_id(0)*32) + get_local_id(0)) <= 127 ==> Perm(_in_in_even__0_0[get_local_id(0)], write);
 ensures \ltid<32&& get_group_id(0)*32 + get_local_id(0) <= 126 ==> _even[(get_group_id(0)*32) + get_local_id(0)] % 2 == 0;
@*/
 ...
 __local int* _in_in_even__0_0)
{
 ...
 /*@
  ...
  requires (((get_group_id(0)*32) + get_local_id(0)) <= 127 && get_local_id(0) < 33) 
    ==> _in_in_even__0_0[get_local_id(0)] % 2 == 0;


  requires _in != NULL;
  context \ltid<33&&  ((get_group_id(0)*32) + get_local_id(0)) <= 127 
    ==> Perm(_in[(get_group_id(0)*32) + get_local_id(0)], read);
  requires (((get_group_id(0)*32) + get_local_id(0)) <= 127 && get_local_id(0) < 33) 
    ==> _in_in_even__0_0[get_local_id(0)] == _in[(get_group_id(0)*32) + get_local_id(0)];
 

  ensures (((get_group_id(0)*32) + get_local_id(0)) <= 126 && get_local_id(0) == 0)
     ==> Perm(_in_in_even__0_0[get_local_id(0)], 1);
  ensures (((get_group_id(0)*32) + get_local_id(0)) <= 126 && get_local_id(0) > 0 && get_local_id(0) < 32) 
     ==> Perm(_in_in_even__0_0[get_local_id(0)], 1\2);
  ensures (((get_group_id(0)*32) + get_local_id(0)) <= 126 && get_local_id(0) == 31)
     ==> Perm(_in_in_even__0_0[get_local_id(0)+1], 1);
  ensures (((get_group_id(0)*32) + get_local_id(0)) <= 126 && get_local_id(0) < 31) 
     ==> Perm(_in_in_even__0_0[get_local_id(0)+1], 1\2);

  ensures (((get_group_id(0)*32) + get_local_id(0)) <= 126 && get_local_id(0) < 32) 
     ==> _in_in_even__0_0[get_local_id(0)] % 2 == 0;
  ensures (((get_group_id(0)*32) + get_local_id(0)) <= 126 && get_local_id(0) < 32) 
     ==> _in_in_even__0_0[get_local_id(0)+1] % 2 == 0;
 @*/
