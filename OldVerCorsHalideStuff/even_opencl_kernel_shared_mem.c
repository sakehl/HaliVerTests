...
// writes to local
//@ requires (((get_group_id(0)*32) + get_local_id(0)) <= 127 && get_local_id(0) < 33) ==> Perm(_in_in_even__0_0[get_group_id(0) * 33 + get_local_id(0)], write);
/*@ ensures (((get_group_id(0)*32) + get_local_id(0)) <= 126 && get_local_id(0) < 33 
    && get_local_id(0) == 0)
      ==> Perm(_in_in_even__0_0[get_group_id(0) * 33 + get_local_id(0)], 1);
   ensures (((get_group_id(0)*32) + get_local_id(0)) <= 126 && get_local_id(0) < 33 
    && get_local_id(0) > 0 && get_local_id(0) < 32) 
      ==> Perm(_in_in_even__0_0[get_group_id(0) * 33 + get_local_id(0)], 1\2);
   ensures (((get_group_id(0)*32) + get_local_id(0)) <= 126 && get_local_id(0) < 33 
    && get_local_id(0) == 31)
      ==> Perm(_in_in_even__0_0[get_group_id(0) * 33 + get_local_id(0)+1], 1);
   ensures (((get_group_id(0)*32) + get_local_id(0)) <= 126 && get_local_id(0) < 33 
    && get_local_id(0) < 31) 
      ==> Perm(_in_in_even__0_0[get_group_id(0) * 33 + get_local_id(0)+1], 1\2);
@*/
 ...
 __local int16* _in_in_even__0_0)
{
 ...
 if (_14)
 {
  ...
  int _17 = _in[_16];
  (_in_in_even__0_0)[_even_s0_x_bx___block_id_x*33 + ___thread_id_x] = _17;
 } // if _14
 
 // We add get_local_id(0) < 33 because of upper bounds detection for rewrite quantifier pass in vercors, but it is `theoertically` 
 ...
 if (_23)
 {
  int _24 = (_in_in_even__0_0)[_even_s0_x_bx___block_id_x*33 + ___thread_id_x];
  int _25 = ___thread_id_x + 1;
  int _26 = (_in_in_even__0_0)[_even_s0_x_bx___block_id_x*33 + _25];
  int _27 = _24 + _26;
